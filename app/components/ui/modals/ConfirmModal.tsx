    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog autoFocus as="div" className="fixed inset-0 z-50 overflow-y-auto" onClose={setOpen}>
        <div className="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
          ...
          >
            <div className="bg-background inline-block w-full transform overflow-hidden rounded-lg px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6 sm:align-middle">
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  <Dialog.Title as="h3" className="text-foreground text-lg font-medium leading-6">
                    {title}
                  </Dialog.Title>
                  <div className="mt-2">
